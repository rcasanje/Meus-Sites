...
<head>
	...
	<title>Para seu design pessoal | Print Ideas</title>
			...
			<section class="content">
				...
				if($query = mysqli_query($conn, $dados)){
					while($info = mysqli_fetch_array($query, MYSQL_ASSOC)){
						...
						echo montarVisualizacaoProduto($codigoProd, $abspath."images/Produtos/".$caminhoImg[0], $nomeProd, $prazo, $preco, $qntd);
					}
				} else{
