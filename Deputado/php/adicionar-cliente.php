...
$dados = "INSERT INTO clientes (nome_cli, nomeMae_cli, nomePai_cli, dataNasc_cli, endereco_cli, municipio_cli, bairro_cli, telefone_cli, email_cli, zona_cli, indicacao_cli, ingressado_cli) VALUES ('$nome', '$nomeMae', '$nomePai', '$dataNasc', '$endereco', '$municipio', '$bairro', '$telefone', '$email', '$zonaE', '$codigoA', '$data')";
