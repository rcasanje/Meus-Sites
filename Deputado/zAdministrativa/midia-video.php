				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							...
							<div style="width: 220%;">
								<form action="../php/upload-video.php" class="dropzone" enctype="multipart/form-data" id="imageUpload"></form>
							</div>
							<br>
							<div style=" width: 220%;">
								<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive" cellspacing="0" width="100%">
									...
									<tbody>
										<?php
										$dados = "SELECT * FROM videos";

										if($query = mysqli_query($link, $dados)){
											while ($rows = mysqli_fetch_row($query)){
												printf( '<tr>
														<td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>%s</td><td>Excluir/Editar</td>
													</tr>', $rows[0], $rows[1], $rows[2], $rows[3], $rows[4]);
											}
										}
										?>
