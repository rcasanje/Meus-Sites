								...
								<div class="box-body">
									<div class="row">
										...
										<div class="col-md-6">
											<div class="input-group">
												<span class="input-group-addon"><i class="fa fa-asterisk"></i></span>
												<input type="password" class="form-control" placeholder="Confirma Senha" name="csenha">
											</div>
										</div>
										<div class="col-md-6">
											<div class="input-group">
										...
										<div class="col-md-6">
											<div class="input-group">
												<span class="input-group-addon"><i class="fa fa-at"></i></span>
												<input type="email" class="form-control" placeholder="Confirma Email" name="cemail">
											</div>
										</div>
									</div>
									<hr>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												<div class="checkbox">
													<label>
														<input type="checkbox" name="termsprivacy">Concordo com os <a href="termsofprivacy.php">Termos de Privacidade</a>
													</label>
												</div>
												<div class="checkbox">
													<label>
														<input type="checkbox" name="newsletter">Desejo receber no meu email cadastrado notícias, newsletter e promoções de Print Ideas</a>
													</label>
												</div>
											</div>
										</div>
